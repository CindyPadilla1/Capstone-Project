                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {submitted && (
                            <div className="text-center mb-3">
                                ...
                                {trustResult && (
                                    <div className="text-start p-3" style={{ background: "#1a1a2e", borderRadius: "8px" }}>
                                        ...
                                        <div className="d-flex justify-content-between text-white small mb-1">
                                            <span>Did you feel safe? <strong>{feltSafe}</strong></span>
                                            <span style={{ color: feltSafe === "No" ? "#ff6b6b" : "#51cf66" }}>
                        {feltSafe === "No" ? "-5" : "+2"}
                    </span>
                                        </div>
                                        <div className="d-flex justify-content-between text-white small mb-1">
                                            <span>Boundaries respected? <strong>{boundariesRespected}</strong></span>
                                            <span style={{ color: boundariesRespected === "No" ? "#ff6b6b" : "#51cf66" }}>
                        {boundariesRespected === "No" ? "-4" : "+2"}
                    </span>
                                        </div>
                                        <div className="d-flex justify-content-between text-white small mb-1">
                                            <span>Felt pressured? <strong>{feltPressured}</strong></span>
                                            <span style={{ color: feltPressured === "Yes" ? "#ff6b6b" : "#51cf66" }}>
                        {feltPressured === "Yes" ? "-3" : "0"}
                    </span>
                                        </div>
                                        <div className="d-flex justify-content-between text-white small mb-1">
                                            <span>Comfort level: <strong>{comfortScore}/5</strong></span>
                                            <span style={{ color: comfortScore >= 4 ? "#51cf66" : "#aaa" }}>
                        {comfortScore >= 4 ? "+1" : "0"}
                    </span>
                                        </div>
                                        ...
                                        <div className="d-flex justify-content-between text-white fw-bold">
                                            ...
                                            <span style={{ color: trustResult.internal_delta < 0 ? "#ff6b6b" : "#51cf66" }}>
                        {trustResult.internal_delta > 0 ? "+" : ""}{trustResult.internal_delta}
                    </span>
                                        </div>
                                        {trustResult.label && (
                                            <p className="text-white-50 small mt-2 mb-0 text-center">
                                                Updated rating: <strong className="text-white">{trustResult.label}</strong>
                                            </p>
                                        )}
                                    </div>
                                )}
